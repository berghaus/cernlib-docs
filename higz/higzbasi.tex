...
\begin{figure}[p]
\begin{center}\mbox{\epsfig{file=higznwt.eps,width=\the\textwidth}}\end{center}
...
\end{DLtt}
\begin{Fighere}
\begin{center}\mbox{\epsfig{file=fais.eps,width=\the\textwidth}}\end{center}
...
\begin{figure}[p]
\begin{center}\mbox{\epsfig{file=line.eps}}\end{center}
\caption{Line styles available.}
\label{LINE-TYPE}

\bigskip

\begin{center}\mbox{\epsfig{file=linew.eps}}\end{center}
...
\begin{figure}[p]
\begin{center}\mbox{\epsfig{file=marker.eps}}\end{center}
\caption{\HIGZ~Marker type (20-31).}
\label{MARKER-TYPE}

\bigskip

\begin{center}\mbox{\epsfig{file=markersf.eps}}\end{center}
...
\end{DLtt}
\begin{Fighere}
\begin{center}\mbox{\epsfig{file=align.eps}}\end{center}
