...
%                                                                 %
%   List of all defined commands (to be read to define LaTeX      %
%   commands for all relevant entries                             %
%                                                                 %
%   EPS file      : none                                          %
%                                                                 %
%   Editor: Michel Goossens / CN-AS                               %
%   Last Mod.: 13 October 1992 15:00 mg                           %
%                                                                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\endinput
% First definition to set up unequivocal commands
\newcommand{\DEFCMD}[4]{%
       {\def_{}\xdef\tmp{#1}}% label
       \def\_{\char'137\relax}
        \expandafter\gdef\csname\tmp\endcsname{{\tt#3}\CMIX{X}{#3}{#2}}}
